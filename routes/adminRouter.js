...
import { editcategory, addCategory, renameCategory, getNestedCategories } from '../src/controllers/admin_category_controller.js';
...
router.post("/renamecategory", renameCategory);
